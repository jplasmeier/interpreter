...
(string-append "test 6: " (if (eq? (interpret "testcases/Test3-06.txt" ) 115) "passed" "failed"))
(string-append "test 7: " (if (eq? (interpret "testcases/Test3-07.txt" ) "TRUE") "passed" "failed"))
(string-append "test 8: " (if (eq? (interpret "testcases/Test3-08.txt" ) 20) "passed" "failed"))
(string-append "test 9: " (if (eq? (interpret "testcases/Test3-09.txt" ) 24) "passed" "failed"))
(string-append "test 10: " (if (eq? (interpret "testcases/Test3-10.txt" ) 2) "passed" "failed"))
(string-append "test 11: " (if (eq? (interpret "testcases/Test3-11.txt" ) 35) "passed" "failed"))
;(string-append "test 12: " (if (eq? (interpret "testcases/Test3-12.txt" ) (error)) "passed" "failed")) ; mismatched num of params/args
(string-append "test 13: " (if (eq? (interpret "testcases/Test3-13.txt" ) 90) "passed" "failed"))
(string-append "test 14: " (if (eq? (interpret "testcases/Test3-14.txt" ) 69) "passed" "failed"))
(string-append "test 15: " (if (eq? (interpret "testcasesases/Test3-15.txt" ) 87) "passed" "failed"))
